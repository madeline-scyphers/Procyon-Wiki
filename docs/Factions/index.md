...
<iframe src="https://docs.google.com/spreadsheets/d/14KeUXYA6ppnNxd7BM4XapvXclCkykn9tfcB4piMNOY4/edit?usp=editing" style="border:0px #ffffff none;" name="myiFrame" frameborder="1" marginheight="0px" marginwidth="0px" width=500 height=750 allowfullscreen></iframe>
...
Fierce individualistic pirates who specialize in disabling ships before boarding. Mostly found in [Iota](../Procyon/Iota/index.md) and [Brekk](../Procyon/Brekk/index.md).

---

# [Dyrinek Gang](./Dyrinek%20Gang.md)

Mostly young, disenfranchised xenos who have turned to crime and found strength and solidarity with each other. Based on [Warren](../Procyon/Rin/Warren.md) but looking to expand wherever there are other like-minded folks.
...
A powerful Noble House of the Hegemony, ostensibly owns the sector. Represented by the [Governor](../Characters/Governor%20Ritam%20al%E2%80%99Malklaith.md), who lives on [Warren](../Procyon/Rin/Warren.md).

---

# [Isotropa Max Secure](./Isotropa%20Max%20Secure.md)

The most notorious prison system in the [Procyon](../Procyon/index.md) sector, housing the worst of the worst. Brokers audiences with its population grants commutations for those with power and wealth.
...
Hegemonic counterintelligence and spies. Currently at odds with [House Malklaith](./House%20Malklaith.md). They seek to undermine the [Governor](../Characters/Governor%20Ritam%20al%E2%80%99Malklaith.md) in order to make a case for change in House control.
...
A [Holt](../Procyon/Holt/index.md)animal parts and Vosian crystals—which they sometimes have trouble sourcing.
