...
Fierce individualistic pirates who specialize in disabling ships before boarding. Mostly found in [Iota](../Atlas/Procyon/Iota/index.md) and [Brekk](../Atlas/Procyon/Brekk/index.md).

---

# [Dyrinek Gang](./Dyrinek%20Gang.md)

Mostly young, disenfranchised xenos who have turned to crime and found strength and solidarity with each other. Based on [Warren](../Atlas/Procyon/Rin/Warren.md) but looking to expand wherever there are other like-minded folks.
...
A powerful Noble House of the Hegemony, ostensibly owns the sector. Represented by the Governor, who lives on [Warren](../Atlas/Procyon/Rin/Warren.md).

---

# [Isotropa Max Secure](./Isotropa%20Max%20Secure.md)

The most notorious prison system in the [Procyon](../Atlas/Procyon/index.md) sector, housing the worst of the worst. Brokers audiences with its population grants commutations for those with power and wealth.
...
A [Holt](../Atlas/Procyon/Holt/index.md)animal parts and Vosian crystals—which they sometimes have trouble sourcing.
