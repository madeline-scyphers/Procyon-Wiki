...
- A map of [Procyon](../Atlas/Procyon/Procyon.md) from before the Hegemony.
- Exploration ships.
...
A retrieved message about a powerful artifact that could terraform previously dead worlds ignited a fervor in a number of Hegemonic youths. Taking an oath blessed by the Hegemon to find it, they're looking all over the Galaxy. Nicols recently found a marked map of [Procyon](../Atlas/Procyon/Procyon.md) predating the Hegemony.
